...
-- Ai-Taxi Settings
Taxi = {
	Plate = "ERRORHUB", -- The number plate of the taxi. A maximum of 8 characters (numbers/alphabets) is allowed.
...
AirportBlip = {
	Enabled = true, -- Set to true to enable the blip
	...
	Scale = 0.7, -- The size of the airport blip
